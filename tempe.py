...
def user_input_features():
  # Entrada
  Mes = st.number_input('Edad:', min_value=0, max_value=12, value = 0, step = 1)
  Año = st.number_input('Género (Mujer = 0, Hombre = 1):',  min_value=0, max_value=20, value = 0, step = 1)
  Ciudad = st.number_input('Estatura (en cm):', min_value=0, max_value=5, value = 0, step = 1)
...
b1 = LR.coef_
b0 = LR.intercept_
prediccion = b0 + b1[0]*df['year'] + b1[1]*df['month'] + b1['City']
